...
const CreateUserPage = () => {
  ...
  const { btnLoading, adminCreateUser, dashUser } = useUser();
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Add new user details and set permissions
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                <label
                  className={`flex items-center space-x-3 ${
                    dashUser?.role !== "admin" ? "cursor-not-allowed" : "cursor-pointer"
                  }`}
                >
                  <input
                    type="checkbox"
                  ...
                  <div>
                    <span
                      className={`text-sm font-medium ${
                        dashUser?.role !== "admin" ? "text-gray-500" : "text-gray-700"
                      }`}
                    >
                      Active User
                    </span>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <button
                ...
                disabled={btnLoading}
                className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-medium py-3 px-6 rounded-lg transition-all duration-200 flex items-center justify-center"
              >
                {btnLoading ? (
                  <>
