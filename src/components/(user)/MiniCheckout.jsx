...
const MiniCheckout = ({ 
  ...
  const grandTotal = (cart?.totalAmount || 0) + deliveryCharge + handlingCharge + smallCartCharge;
          ...
          {cart?.items && cart.items.length > 0 && (
            <div className="bg-green-50 border-b border-green-100 px-4 py-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">Delivery in 30 minutes</h3>
                  <p className="text-sm text-gray-600">Shipment of {cart.items.length} item{cart.items.length > 1 ? 's' : ''}</p>
                </div>
              </div>
            </div>
          )}
          ...
          {!cart?.items || cart.items.length === 0 ? (
            ...
            <div className="px-4 py-4 space-y-4">
              {cart.items.map((item, index) => {
                ...
                const productSlug = typeof item.productId === "object" ? item.productId.slug : null;
                  ...
                  <div key={index} className="flex gap-3 pb-4 border-b border-gray-100 last:border-0">
                    ...
                    <div className="flex-shrink-0">
                      {item.image && productSlug ? (
                        <Link href={`/productdetails/${productSlug}`} onClick={onClose}>
                          <img
                            src={item.image}
                            alt={item.title}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-base font-bold text-gray-900">₹{item.finalPrice}</p>
                    </div>
                    ...
                    <div className="flex flex-col items-end justify-between">
                      ...
                      <div className="flex items-center border border-gray-300 rounded-lg bg-white">
                        <button
                          onClick={() => updateCartItem(productId, item.unit, "decrement")}
                        ...
                        <button
                          onClick={() => updateCartItem(productId, item.unit, "increment")}
        ...
        {cart?.items && cart.items.length > 0 && (
          <div className="border-t border-gray-200 bg-gray-50">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-gray-600 flex items-center gap-1">
                    ...
                    <span className="text-xs text-gray-400 cursor-help" title="Standard delivery fee">ⓘ</span>
                  </span>
                ...
                <div className="flex justify-between items-center">
                  <span className="text-gray-600 flex items-center gap-1">
                    ...
                    <span className="text-xs text-gray-400 cursor-help" title="Packaging and handling">ⓘ</span>
                  </span>
                ...
                <div className="flex justify-between items-center">
                  <span className="text-gray-600 flex items-center gap-1">
                    ...
                    <span className="text-xs text-gray-400 cursor-help" title="Applied to orders under threshold">ⓘ</span>
                  </span>
            ...
            <div className="px-4 py-3 bg-orange-50 border-t border-orange-100">
              <h4 className="text-xs font-semibold text-gray-900 mb-1">Cancellation Policy</h4>
